...
var Grant = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(Grant, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('role')) {
          obj['role'] = _Reference["default"].constructFromObject(data['role']);
        }

        if (data.hasOwnProperty('rules')) {
          obj['rules'] = _ApiClient["default"].convertToType(data['rules'], [Object]);
        }
...
Grant.prototype['tags'] = undefined; // Implement Instance interface:
