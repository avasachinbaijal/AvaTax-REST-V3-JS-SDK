 ...
 * @version 2.4.36
 */
var SystemList = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>SystemList</code>.
   * @alias module:model/IAMDS/SystemList
   */
  function SystemList() {
    (0, _classCallCheck2["default"])(this, SystemList);
  ...
  (0, _createClass2["default"])(SystemList, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('items')) {
          obj['items'] = _ApiClient["default"].convertToType(data['items'], [_System["default"]]);
        }
      }
