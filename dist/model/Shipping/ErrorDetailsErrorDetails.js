    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('faultCode')) {
          obj['faultCode'] = _ApiClient["default"].convertToType(data['faultCode'], 'String');
        }

        if (data.hasOwnProperty('helpLink')) {
          obj['helpLink'] = _ApiClient["default"].convertToType(data['helpLink'], 'String');
        }
...
var _default = ErrorDetailsErrorDetails;
