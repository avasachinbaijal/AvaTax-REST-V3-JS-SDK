...
var _Feature = _interopRequireDefault(require("../../model/IAMDS/Feature"));
...
* @version 2.4.36
*/
var FeatureApi = /*#__PURE__*/function () {
  /**
  ...
  */
  function FeatureApi(apiClient) {
    (0, _classCallCheck2["default"])(this, FeatureApi);
  ...
  (0, _createClass2["default"])(FeatureApi, [{
    key: "createFeature",
    value: function createFeature(opts, callback) {
      opts = opts || {};
      var postBody = opts['feature'];
      var pathParams = {};
      var queryParams = {};
      var headerParams = {
      ...
      return this.apiClient.callApi('/features', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback, requiredScopes);
    }
    /**
    ...
    key: "deleteFeature",
    value: function deleteFeature(featureId, opts, callback) {
      opts = opts || {};
      ...
      var returnType = null;
      return this.apiClient.callApi('/features/{feature-id}', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback, requiredScopes);
    }
    /**
    ...
    key: "getFeature",
    value: function getFeature(featureId, opts, callback) {
      opts = opts || {};
      var postBody = null; // verify the required parameter 'featureId' is set
      ...
      var accepts = ['application/json', 'text/plain'];
      var returnType = _Feature["default"];
      return this.apiClient.callApi('/features/{feature-id}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback, requiredScopes);
    }
    /**
    ...
    key: "listFeatureGrants",
    value: function listFeatureGrants(featureId, opts, callback) {
      opts = opts || {};
      var postBody = null; // verify the required parameter 'featureId' is set
      ...
      return this.apiClient.callApi('/features/{feature-id}/grants', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback, requiredScopes);
    }
    /**
    ...
    key: "listFeatures",
    value: function listFeatures(opts, callback) {
      opts = opts || {};
      var postBody = null;
      var pathParams = {};
      var queryParams = {
      ...
      return this.apiClient.callApi('/features', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback, requiredScopes);
    }
    /**
    ...
    key: "patchFeature",
    value: function patchFeature(featureId, opts, callback) {
      opts = opts || {};
      var postBody = opts['feature']; // verify the required parameter 'featureId' is set
      ...
      var accepts = ['text/plain'];
      var returnType = null;
      return this.apiClient.callApi('/features/{feature-id}', 'PATCH', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback, requiredScopes);
    }
    /**
    ...
    key: "replaceFeature",
    value: function replaceFeature(featureId, opts, callback) {
      opts = opts || {};
      var postBody = opts['feature']; // verify the required parameter 'featureId' is set
      ...
      var accepts = ['text/plain'];
      var returnType = null;
      return this.apiClient.callApi('/features/{feature-id}', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback, requiredScopes);
    }
  }]);
  return FeatureApi;
}();

exports["default"] = FeatureApi;