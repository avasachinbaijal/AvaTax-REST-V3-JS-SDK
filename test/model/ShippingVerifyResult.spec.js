...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvalaraSdk.Shipping.ShippingVerifyResult();
  });
  ...
  describe('ShippingVerifyResult', function() {
    it('should create an instance of ShippingVerifyResult', function() {
      ...
      //var instance = new AvalaraSdk.ShippingVerifyResult();
      //expect(instance).to.be.a(AvalaraSdk.ShippingVerifyResult);
    });
