...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvalaraNodeAsv.ShippingVerifyResultLines();
  });
  ...
  describe('ShippingVerifyResultLines', function() {
    it('should create an instance of ShippingVerifyResultLines', function() {
      ...
      //var instance = new AvalaraNodeAsv.ShippingVerifyResultLines();
      //expect(instance).to.be.a(AvalaraNodeAsv.ShippingVerifyResultLines);
    });
